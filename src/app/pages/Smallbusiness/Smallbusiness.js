...
import ButtonViewDark from '@/app/components/elements/buttonViewDark'
import Image from 'next/image'
import Subtitle from '@/app/components/elements/Subtitle'

import Headtitle, { Headtitle1 } from '../../elements/Headtitle'
  ...
  return (
    <>
                ...
                <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                    ...
                    <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0 places-content-center places-items-center container">
                        <div className="flex -bottom-10 flex-col relative p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                            ...
                            <button class="text-white bg-[#4556F5] hover:bg-primary-700 focus:ring-4 focus:ring-primary-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:text-white  dark:focus:ring-primary-900">Get started</button>
                        </div>
        ...
        <section className='bg-black flex flex-col items-center py-4'>
            ...
            <div className='py-24'>
                <ButtonView text="plus d'options" />
            </div>
        </section>
